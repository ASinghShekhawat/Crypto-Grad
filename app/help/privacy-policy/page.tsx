  ...
  return (
    <div className="relative mx-auto flex max-w-[960px] flex-col items-center gap-12 px-4 pb-16 pt-8 mmd:gap-24 mmd:px-16 mmd:pb-32 mmd:pt-24">
      ...
      <div className="flex w-full flex-col gap-8">
        ...
        <div className="flex w-full flex-col gap-4">
          <h3 className="text-2xl">1. Analyse the Data</h3>
          <p>
            The first step is to analyse the data you have collected. Look for
            patterns and trends in the data that can help you understand your
            customers&apos; behaviour, preferences, and needs.
          </p>
        </div>
        <div className="flex w-full flex-col gap-4">
          <h3 className="text-2xl">2. Identify Areas for Improvements</h3>
          <p>
            Based on the insights you gain from analysing the data, identify
            areas where you can improve your products, services, or customer
            experience. For example, if you find that customers are frequently
            complaining about the same issue, you may need to address that issue
        ...
        <div className="flex w-full flex-col gap-4">
          ...
          <p>
            Use the information you have collected to develop targeted marketing
            campaigns that speak directly to your customers&apos; needs and
            interests. For example, if you find that a particular demographic
            prefers a certain type of product, you can develop marketing
            campaigns that focus on that product and speak directly to that
            demographic.
          </p>
        </div>
        <div className="flex w-full flex-col gap-4">
          <div className="text-2xl">4. Forecast Future Trends</div>
          <p>
            Use the data you have collected to forecast future trends and
            anticipate future customer needs. This can help you stay ahead of
            the competition and ensure that you are meeting your customers&apos;
            evolving needs
          </p>
        </div>
        <div className="flex w-full flex-col gap-4">
          <div className="text-2xl">5. Personalise Your Interactions</div>
          <p>
            Use the information you have collected to personalise your
            interactions with customers. For example, if you know that a
            customer has a specific preference or need, you can tailor your
            communication and recommendations to meet that need.
          </p>
        </div>
      </div>
      <div className="flex w-full flex-col gap-8">
      ...
      <div className="flex w-full flex-col gap-4">
        <h2 className="text-3xl font-medium md:text-4xl">Your Choices</h2>
        <p>
        ...
        <p>
          You can also disable cookies or change your browser settings to block
          cookies. However, if you disable cookies, some features of our Site
