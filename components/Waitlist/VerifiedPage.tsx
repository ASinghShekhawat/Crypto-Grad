...
const VerifiedPage = () => {
  ...
  return showInviteDialog ? (
    ...
    <Page className="flex h-full items-start justify-center md:items-center">
      <div className="relative overflow-hidden md:rounded-3xl md:w-[500px] md:bg-themeBlack md:p-8">
        <Image
        ...
        />
        <h1 className="relative z-1 mb-2 mt-2 text-center text-lg font-semibold text-white md:mt-8 md:text-2xl">
        ...
        <h1 className="relative z-1 mb-0 mt-8 text-center text-lg font-semibold text-white md:text-lg">
          You Earned
        </h1>
        ...
        <div className="relative z-1 flex items-center justify-center">
          <Image
            ...
            width={60}
            alt="brand-logo"
            className="mb-5 w-20 md:mb-4 md:w-28"
          />
          <h1 className="mb-6 mr-3 text-center text-2xl font-bold text-white md:text-4xl">
            100 CG Tokens
          </h1>
        </div>
        <div className="relative z-1 mb-8 grid-cols-2 justify-center gap-4 md:grid">
          <div className="flex items-center justify-center">
            <div className="md:bg-themePositionBg w-full items-center justify-center rounded-md p-2 px-2 py-4 text-center md:mb-4">
        ...
        <div className="relative z-1 flex items-center justify-center">
          <div className="bg-themePositionBg m-1 flex w-full items-center justify-center rounded-md p-1 text-center md:mb-4">
        ...
        <Button
          ...
          className='mt-8 w-full relative z-1'
        >
          Invite Friends
        </Button>
      </div>
