...
const GrowthImage = () => {
  return (
    <div className="relative w-full">
      ...
      <Animated
        delay={400}
        className="absolute top-[35%] -right-8 !scale-50 rounded-lg border border-themeTextGrey/40 bg-themeBlack/75 px-4 py-2 backdrop-blur-lg md:right-[5%] md:top-[50%] md:scale-100 mmd:scale-75 xl:scale-100"
      >
        Access to cool NFTs
      </Animated>
      <Animated
