          ...
          {tab === 'stake' ? (
            <div className="flex gap-2">
              <Button
                ...
                type={
                  stakePlan === '1' ? ButtonType.PRIMARY : ButtonType.SECONDARY
                }
              >
                1 Month
              </Button>
              <Button
                ...
                className="!px-4 text-sm"
                type={
                  stakePlan === '3' ? ButtonType.PRIMARY : ButtonType.SECONDARY
                }
              >
                3 Month
              </Button>
              <Button
                ...
                className="!px-4 text-sm"
                type={
                  stakePlan === '12' ? ButtonType.PRIMARY : ButtonType.SECONDARY
                }
              >
                12 Month
              </Button>
            ...
            <div className="flex gap-2">
              <Button
                ...
                type={
                  unStakePlan === 25 ? ButtonType.PRIMARY : ButtonType.SECONDARY
                }
              >
                25%
              </Button>
              <Button
                ...
                className="w-full !px-4 text-sm"
                type={
                  unStakePlan === 50 ? ButtonType.PRIMARY : ButtonType.SECONDARY
                }
              >
                50%
              </Button>
              <Button
                ...
                className="w-full !px-4 text-sm"
                type={
                  unStakePlan === 75 ? ButtonType.PRIMARY : ButtonType.SECONDARY
                }
              >
                75%
              </Button>
